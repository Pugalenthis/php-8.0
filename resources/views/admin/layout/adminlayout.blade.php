...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__wobble" src="{{asset('adminpanel/dist/img/AdminLTELogo.png')}}" alt="AdminLTELogo" height="60" width="60">
    </div>
...
<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src="{{asset('adminpanel/plugins/jquery-mousewheel/jquery.mousewheel.js')}}"></script>
<script src="{{asset('adminpanel/plugins/raphael/raphael.min.js')}}"></script>
<script src="{{asset('adminpanel/plugins/jquery-mapael/jquery.mapael.min.js')}}"></script>
<script src="{{asset('adminpanel/plugins/jquery-mapael/maps/usa_states.min.js')}}"></script>
<!-- ChartJS -->
...
<script src="{{asset('adminpanel/dist/js/pages/dashboard2.js')}}"></script>
</body>
</html>
